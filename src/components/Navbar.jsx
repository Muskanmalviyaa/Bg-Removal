  ...
  return (
    <div className='flex items-center justify-between mx-4 py-3 lg:mx-44 '>
      <Link to='/'><img className='w-32 sm:w-44' src={assets.logo} alt='Logo' /></Link>
      {
        ...
        <button onClick={() => navigate('/buy-credit')} className='flex items-center gap-2 bg-blue-100 px-3 sm:px-6 py-1.5 sm:py-2.5 rounded-full hover:scale-105 transition-all duration-600'>
